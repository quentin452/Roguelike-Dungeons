...
public class DungeonReward extends DungeonBase {
    ...
    public boolean generate(IWorldEditor editor, Random rand, LevelSettings settings, Cardinal[] entrances,
        ...
        RectSolid.fill(
                ...
                BlockType.get(BlockType.AIR));
        RectHollow.fill(
                editor,
                rand,
                new Coord(x - 8, y - 1, z - 8),
                new Coord(x + 8, y + 6, z + 8),
        ...
        for (Cardinal dir : Cardinal.directions) {
            for (Cardinal orth : Cardinal.orthogonal(dir)) {
                ...
                RectSolid
                        .fill(editor, rand, cursor, end, stair.setOrientation(Cardinal.reverse(dir), true), true, true);
                cursor.add(Cardinal.UP);
                end.add(Cardinal.UP);
