...
public class DungeonLab extends DungeonBase {
    ...
    public boolean generate(IWorldEditor editor, Random rand, LevelSettings settings, Cardinal[] entrances,
        ...
        RectHollow.fill(
                editor,
                rand,
                new Coord(x - 8, y - 1, z - 8),
                new Coord(x + 8, y + 4, z + 8),
                blocks,
                false,
                true);
        RectSolid.fill(
    ...
    private static void corner(IWorldEditor editor, Random rand, ITheme theme, int x, int y, int z) {
        ...
        RectHollow.fill(
                editor,
                rand,
                new Coord(x + 1, y + 4, z + 1),
                new Coord(x + 4, y + 8, z + 4),
                cobble,
                false,
                true);
    ...
    private static void northWest(IWorldEditor editor, Random rand, ITheme theme, int x, int y, int z) {
        ...
        stair.setOrientation(Cardinal.SOUTH, false)
                .fill(editor, rand, new RectSolid(new Coord(x + 2, y, z + 1), new Coord(x + 4, y, z + 1)));
        stair.setOrientation(Cardinal.EAST, false)
                .fill(editor, rand, new RectSolid(new Coord(x + 1, y, z + 2), new Coord(x + 1, y, z + 4)));
    ...
    private static void northEast(IWorldEditor editor, Random rand, ITheme theme, int x, int y, int z) {
        ...
        stair.setOrientation(Cardinal.SOUTH, false)
                .fill(editor, rand, new RectSolid(new Coord(x + 1, y, z + 1), new Coord(x + 3, y, z + 1)));
        stair.setOrientation(Cardinal.WEST, false)
                .fill(editor, rand, new RectSolid(new Coord(x + 4, y, z + 2), new Coord(x + 4, y, z + 4)));
