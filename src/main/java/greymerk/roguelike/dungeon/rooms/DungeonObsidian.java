...
public class DungeonObsidian extends DungeonBase {
        ...
        for (Cardinal dir : Cardinal.directions) {
            for (Cardinal orth : Cardinal.orthogonal(dir)) {
                ...
                Treasure.generate(
                        ...
                        Dungeon.getLevel(chestPos.getY()));
            }
        }
    ...
    private static void outerPillar(IWorldEditor editor, Random rand, ITheme theme, Coord pillarLocation,
            Cardinal dir) {
        ...
        for (Cardinal dir : Cardinal.directions) {
            for (Cardinal orth : Cardinal.orthogonal(dir)) {
                ...
                RectSolid.fill(
                        editor,
                        rand,
                        new Coord(pillar.getX(), y - 4, pillar.getZ()),
                        new Coord(pillar.getX(), y + 4, pillar.getZ()),
                        secondaryWall);
                pillar.add(dir, 4);
                RectSolid.fill(
