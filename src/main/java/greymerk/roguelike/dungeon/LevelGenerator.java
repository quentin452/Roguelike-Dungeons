...
public enum LevelGenerator {
    ...
    public static ILevelGenerator getGenerator(IWorldEditor editor, Random rand, LevelGenerator type,
            IDungeonLevel level) {
        switch (type) {
            case CLASSIC:
    ...
    public static void generateLevelLink(IWorldEditor editor, Random rand, LevelSettings settings, Coord start,
            DungeonNode oldEnd) {
