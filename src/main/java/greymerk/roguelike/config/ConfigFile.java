...
public class ConfigFile extends ConfigurationProvider {
    ...
    public ConfigFile(String filename, ConfigurationParser parser) throws Exception {
        ...
        for (;;) {
            ...
            // into the hash map
            kvp.put(config.Key, config.Value);
    ...
    /**
     * Writes configurations back to the file from which they were originally drawn, according to the strategy used to
     * parse them.
     */
    public void Write() throws Exception {

        ConfigFileWriter.Write(filename, this, parser);
