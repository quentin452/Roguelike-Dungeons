 ...
 * That is, key/value pairs are separated by an equals sign, on their own line, empty lines and lines that begin with a
 * number sign are disregarded.
 */
public class INIParser implements ConfigurationParser {
    ...
    private final Pattern comment_pattern;
