...
public abstract class ConfigurationProvider implements Iterable<Configuration> {
    ...
    private final Pattern true_pattern;
    private final Pattern false_pattern;
     ...
     * \return \em true if \em key has associated data in the configuration store, \em false otherwise.
     */
     ...
     * \param [in] key The key whose associated configuration information is to be retrieved. \param [in] fallback A
     * value which shall be retrieved if no configuration is associated with \em key.
     ...
     * \param [in] key The key whose associated configuration information is to be retrieved. \param [in] fallback The
     * value which will be retrieved if \em key is not present, or if \em key could not be parsed to a double.
     ...
     * \param [in] key The key whose associated configuration information is to be retrieved. \param [in] fallback The
     * value which will be retrieved if \em key is not present, or if \em key could not be parsed to an integer.
     * \return Either the configuration associated with \em key, or \em fallback.
     */
     ...
     * \param [in] key The key associated with the configuration to update or create. \param [in] value The value to
     * associate with \em key.
     */
    ...
    /**
     * Fetches an iterator which may be used to traverse the configurations in this provider in alphabetical order.
     * \return An iterator.
     */
    @Override
    ...
    private static class EntryAlphabetical implements Comparator<Map.Entry<String, String>> {
